namespace PracticeProject.Texts {
    ...
    declare namespace Controls {
        ...
        namespace EntityDialog {
            ...
            export const SaveAndClose: string;
            export const SaveAndNew: string;
        }
        export const Forward: string;
        export const FromDate: string;

        namespace KeyboardLayout {
            export const BanglaPhonetic: string;
            export const BanglaProbhat: string;
            export const BanglaUnijoy: string;
            export const English: string;
            export const Title: string;
        }
        export const Loading: string;
        export const Print: string;
        export const SaveAsDraft: string;
